      ...
      <section className="relative min-h-[85vh] flex items-center gradient-hero overflow-hidden">
        ...
        <div className="page-container relative z-10 w-full">
          ...
          >
            ...
            >
              Empowering junior college athletes across
              Mumbai through competitive sports,
            ...
            >
              ...
              <Link
                to="/registration"
                className="px-6 py-3 rounded-lg font-semibold text-base text-white border border-white/30 hover:bg-white/10 transition-all duration-300"
              >
                Register Now
              </Link>
      ...
      <section className="page-container -mt-16 relative z-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <StatCounter
            ...
            label="Sports"
            icon={
              <MdSportsCricket className="w-8 h-8" />
            }
          />
      ...
      <section className="page-container py-16">
        ...
        >
          ...
          <p className="section-subtitle">
            Competitive disciplines across Mumbai's
            junior colleges
          </p>
            ...
            (sport: any, i: number) => (
              ...
              >
                ...
                <Link
                  ...
                  className="sport-card flex flex-col items-center p-5 text-center group"
                >
      ...
      <section className="page-container py-16">
        ...
        {notices.length === 0 && (
          <div className="text-center text-muted-foreground py-8">
            <FiBell className="mx-auto mb-2 w-6 h-6" />
